...
import "./HalfHandShirt.css";
import Header from "../../../Compoment/Header/Header";
import Footer from "../../../Compoment/Footer/Footer";
import Shirt from "../Assets/shop-shirt-banner-new.jpg";
          ...
          <div key={product.id} className="col-lg-4 col-md-6 col-12">
            ...
            >
              <div className="card-container card_container1">
                ...
                <div className="text-black prices_details">
                  <h5 className="mt-3">{product.name}</h5>
                  <h5 className="mt-3">{product.id}</h5>
                  <h4>{product.category}</h4>
                  <h6 className="fw-bold">
                    <i className="bi bi-currency-rupee"></i>
                    {product.price} &nbsp;
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-12 text-center my-3">
            <img src={Shirt} alt="JoggerImg" className="img-fluid" />
          </div>
        </div>
      </div>
      ...
      <div className="container my-2">
        <div className="row d-flex align-items-center justify-content-between">
          <div className="col-auto">
            <h5 className="fw-bold">Men's Half Hand Shirt</h5>
