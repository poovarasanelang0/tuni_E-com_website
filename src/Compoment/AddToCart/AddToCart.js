...
//     }
//   };
//   // console.log(productDetailsCombo,"addtocartpages +++cartProducts+++combos");
...
//               <div key={comboProduct.data.productDetailsCombo.id}>
//                 <div className="row">
//                   <div className="col-md-4">
//                     <img
...
//                           onClick={() => handleRemoveFromCartCombos(comboProduct.id)}
